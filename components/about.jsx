          ...
          <div className="row">
            ...
            <p className="section-container-spacer">
              ...
              <p className="section-container-spacer">
                ...
                contribuir para melhorar o aprendizado dela e de outros, mas
                apesar de ser sem fins lucrativos, você pode apoiar o projeto
                financeiramente, para poder haver melhorias no servidor
                utilizado, funcionar em mais plataformas e haver mais
                funcionalidades.{" "}
              </p>

              <small className="signature pull-right">
